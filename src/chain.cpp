...
void register_chain()
{
    ...
    bp::class_<graphene::chain::fee_schedule>("FeeSchedule", bp::init<>())
        ...
        .add_property("scale", &graphene::chain::fee_schedule::scale)
    ;
    ...
    bp::class_<graphene::chain::chain_parameters>("ChainParameters", bp::init<>())
        ...
        .add_property("block_interval", &graphene::chain::chain_parameters::block_interval)
        .add_property("maintenance_interval", &graphene::chain::chain_parameters::maintenance_interval)
        .add_property("maintenance_skip_slots", &graphene::chain::chain_parameters::maintenance_skip_slots)
        .add_property("miner_proposal_review_period", &graphene::chain::chain_parameters::miner_proposal_review_period)
        .add_property("maximum_transaction_size", &graphene::chain::chain_parameters::maximum_transaction_size)
        .add_property("maximum_block_size", &graphene::chain::chain_parameters::maximum_block_size)
        .add_property("maximum_time_until_expiration", &graphene::chain::chain_parameters::maximum_time_until_expiration)
        .add_property("maximum_proposal_lifetime", &graphene::chain::chain_parameters::maximum_proposal_lifetime)
        .add_property("maximum_asset_feed_publishers", &graphene::chain::chain_parameters::maximum_asset_feed_publishers)
        .add_property("maximum_miner_count", &graphene::chain::chain_parameters::maximum_miner_count)
        .add_property("maximum_authority_membership", &graphene::chain::chain_parameters::maximum_authority_membership)
        .add_property("cashback_vesting_period_seconds", &graphene::chain::chain_parameters::cashback_vesting_period_seconds)
        ...
        .add_property("miner_pay_vesting_seconds", &graphene::chain::chain_parameters::miner_pay_vesting_seconds)
        .add_property("max_predicate_opcode", &graphene::chain::chain_parameters::max_predicate_opcode)
        .add_property("max_authority_depth", &graphene::chain::chain_parameters::max_authority_depth)
    ;
    ...
    object_wrapper<graphene::chain::global_property_object>::wrap(gp)
        .add_property("parameters", &graphene::chain::global_property_object::parameters)
        ...
        .add_property("next_available_vote_id", &graphene::chain::global_property_object::next_available_vote_id)
    ...
    object_wrapper<graphene::chain::dynamic_global_property_object>::wrap(dgp)
        .add_property("head_block_number", &graphene::chain::dynamic_global_property_object::head_block_number)
        .add_property("head_block_id", &graphene::chain::dynamic_global_property_object::head_block_id)
        .add_property("time", &graphene::chain::dynamic_global_property_object::time)
        .add_property("current_miner", &graphene::chain::dynamic_global_property_object::current_miner)
        .add_property("next_maintenance_time", &graphene::chain::dynamic_global_property_object::next_maintenance_time)
        .add_property("last_budget_time", &graphene::chain::dynamic_global_property_object::last_budget_time)
        ...
        .add_property("accounts_registered_this_interval", &graphene::chain::dynamic_global_property_object::accounts_registered_this_interval)
        .add_property("recently_missed_count", &graphene::chain::dynamic_global_property_object::recently_missed_count)
        .add_property("current_aslot", &graphene::chain::dynamic_global_property_object::current_aslot)
        .add_property("recent_slots_filled", &graphene::chain::dynamic_global_property_object::recent_slots_filled)
        .add_property("dynamic_flags", &graphene::chain::dynamic_global_property_object::dynamic_flags)
        .add_property("last_irreversible_block_num", &graphene::chain::dynamic_global_property_object::last_irreversible_block_num)
    ;
}
